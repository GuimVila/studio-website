...
<div class="article-note">
  <p><strong>Idea clau:</strong> el que es propaga no són les partícules del medi, sinó la pertorbació i l’energia associada.</p>
</div>

<figure>
  <img 
    src="/images/resources/ft-01/sound_propagation.webp" 
    alt="Propagació d'una ona sonora longitudinal en l'aire entre una font sonora i un receptor." 
  />
  <figcaption>
    Una vibració genera una pertorbació mecànica que es propaga a través del medi en forma d’ona sonora. En l’aire, aquesta propagació es manifesta principalment com una successió de compressions i rarefaccions de pressió.
  </figcaption>
</figure>
...
<figure>
  <img 
    src="/images/resources/ft-01/sound_wave.webp" 
    alt="Representació d'una ona sonora longitudinal mostrant compressions, rarefaccions i l'oscil·lació local de les partícules del medi."
  />
  <figcaption>
    Les partícules del medi no viatgen amb l’ona sonora, sinó que oscil·len localment al voltant de la seva posició d’equilibri. Les regions més denses corresponen a compressions, mentre que les més separades corresponen a rarefaccions.
  </figcaption>
</figure>
...
<p class="formula-line">longitud d’ona = velocitat del so / freqüència</p>

En símbols:

<p class="formula-line">λ = v / f</p>
...
<p class="formula-line">λ = 343 / 60 ≈ 5,72 m</p>
...
<div class="article-note">
  <p><strong>Idea clau:</strong> la freqüència descriu una repetició en el temps; la longitud d’ona descriu quant espai ocupa aquesta repetició mentre el so es propaga.</p>
</div>

<figure>
  <img 
    src="/images/resources/ft-01/frequency_wave_length.webp" 
    alt="Comparació entre freqüències i longituds d’ona en una ona sonora longitudinal."
  />
  <figcaption>
    La freqüència determina quantes vegades es repeteix un cicle per segon, mentre que la longitud d’ona descriu la distància física que ocupa aquest cicle en el medi. Les freqüències baixes generen longituds d’ona més grans; les freqüències altes generen longituds d’ona més curtes.
  </figcaption>
</figure>
...
<div class='article-note'>
<p><strong>Nota:</strong> en el següent apartat aprofundirem en el concepte d’amplitud i la seva relació amb l’energia transportada per l’ona sonora. Conceptes com els decibels, l’SPL o la percepció subjectiva del volum es desenvoluparan més endavant en articles específics dedicats al nivell sonor i la psicoacústica.</p>
</div>
...
<figure>
  <img 
    src="/images/resources/ft-01/amplitude_pressure_level.webp" 
    alt="Comparació entre ones sonores amb la mateixa freqüència però amplituds diferents."
  />
  <figcaption>
    Dues ones poden tenir la mateixa freqüència i, per tant, la mateixa longitud d’ona, però amplituds diferents. Quan l’amplitud augmenta, les variacions de pressió entre compressions i rarefaccions són més grans i l’ona transporta més energia.
  </figcaption>
</figure>
