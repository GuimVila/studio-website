...
import { u as useFieldGroup, a as useComponentIcons, _ as _sfc_main$3 } from './Avatar-WBp75ynp.mjs';
import { m as mergeClasses, o as omit } from './index-BmwSzhyF.mjs';
import { t as tv } from './tv-Dyxj8f8C.mjs';
import { p as pickLinkProps, _ as _sfc_main$1, a as _sfc_main$1$1 } from './Link-BWS9Z-cF.mjs';
import { _ as _sfc_main$2 } from './Icon-BXx8hJrs.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx(({ active, ...slotProps }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$1$1, mergeProps(slotProps, {
              "data-slot": "base",
              class: ui.value.base({
                ...
                if (_push3) {
                  ...
                  return [
                    ...
                    renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [
                      unref(isTrailing) && unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$2, {
                        key: 0,
                        name: unref(trailingIconName),
                        "data-slot": "trailingIcon",
                        class: ui.value.trailingIcon({ class: props.ui?.trailingIcon, active })
...
//# sourceMappingURL=Button-16aF0jOV.mjs.map
