...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "42c87ae4-742f-4ebd-84dd-b9d83ac687b3",
  ...
  "public": {
    ...
    "supabase": {
      "url": "https://pzkqgccyzzojplquobkw.supabase.co",
      "key": "sb_publishable_tkGqfHo1hCyYjZEq9u_IiA_2RI-qzew",
      "redirect": false,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
      ...
      "cookieName": "sb",
      "cookiePrefix": "sb-pzkqgccyzzojplquobkw-auth-token",
      "useSsrCookies": true,
      "cookieOptions": {
        "maxAge": 28800,
        "sameSite": "lax",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/guillemvilatorrent/Desktop/Programació /Studio/studio-front/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-site-config": {
...
const _3JQI1bNJ8xaQuCdg8CURddYMPORlB2uBVfgw85KOuMM = defineNitroPlugin(async (nitroApp) => {
...
const _4IuwL5zcwWhyOFcqwATVnpK4tUfkvHlPC3vcatbEjI = (function(nitro) {
...
const plugins = [
  _3JQI1bNJ8xaQuCdg8CURddYMPORlB2uBVfgw85KOuMM,
_4IuwL5zcwWhyOFcqwATVnpK4tUfkvHlPC3vcatbEjI
];
...
const _ljrM3l = defineCachedEventHandler(async (event) => {
...
const _J5ZKpD = eventHandler(async (e) => {
...
const _7T72Hm = defineEventHandler(async (e) => {
  const collections = [];
...
const _42h_Bm = defineEventHandler(async (e) => {
...
const _eXarO5 = defineEventHandler(sitemapXmlEventHandler);

const _YijwFN = eventHandler(async (event) => {
...
const _TYpZ_X = eventHandler(async (event) => {
...
const _8WVott = lazyEventHandler(() => {
...
const _lazy_tR7u4e = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_tR7u4e, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _ljrM3l, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _J5ZKpD, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _7T72Hm, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _42h_Bm, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _eXarO5, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _YijwFN, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _TYpZ_X, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _8WVott, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_tR7u4e, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, setCookie as A, parseQuery as B, withTrailingSlash as C, withoutTrailingSlash as D, serialize$1 as E, isEqual as F, withLeadingSlash as G, parseURL as H, encodeParam as I, encodePath as J, listener as K, getResponseStatus as a, buildAssetsURL as b, getQuery as c, defineRenderHandler as d, createError$1 as e, destr as f, getResponseStatusText as g, getRouteRules as h, useNitroApp as i, defuFn as j, klona as k, hasProtocol as l, isScriptProtocol as m, joinURL as n, getContext as o, publicAssetsURL as p, baseURL as q, createHooks as r, sanitizeStatusCode as s, executeAsync as t, useRuntimeConfig as u, getHeader as v, withQuery as w, toRouteMatcher as x, createRouter$1 as y, defu as z };
